...
class HotelRoomPaymentHistory(models.Model):
    ...
    reservation_obj = models.ForeignKey(HotelRoomReservation, on_delete=models.DO_NOTHING,
                                        related_name='hotelroom_payment_history')
...
class VillaPaymentHistory(models.Model):
    ...
    reservation_obj = models.ForeignKey(VillaReservation, on_delete=models.DO_NOTHING,
                                        related_name='villa_payment_history')
    is_valid = models.BooleanField(default=True)
    date = models.DateTimeField(auto_now_add=True)
    modified_time = models.DateTimeField(auto_now=True)
