...
if not DEBUG:
    MINIO_ENDPOINT = config('MINIO_ENDPOINT', default='booking-yas-storage-s3-console.darkube.app')
    MINIO_ACCESS_KEY = config('MINIO_ACCESS_KEY', 'IQjCNDl1imNIXkasgK4ohZP9Aq8jEAbU')
    MINIO_SECRET_KEY = config('MINIO_SECRET_KEY', 'TZN1rZMfYcNPIlFxwW5LiGOvucSYgs6t')
